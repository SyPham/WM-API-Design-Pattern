...
namespace WM.WebApi.Controllers
{
    ...
    public class ProjectsController : ControllerBase
    {
        ...
        public ProjectsController(IUnitOfWork unitOfWork, IProjectService projectService, ITaskService taskService, IHubContext<WorkingManagementHub> hubContext)
        {
